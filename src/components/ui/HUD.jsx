...
function HUD() {
  ...
  return (
    <div className="absolute top-24 sm:top-32 md:top-36 left-2 sm:left-4 space-y-2 sm:space-y-3 pointer-events-auto">
      ...
      <div className="bg-gray-800 bg-opacity-90 px-2 py-2 sm:px-3 sm:py-2.5 md:px-4 md:py-3 rounded-lg border-2 border-gray-600">
        ...
        {!isMaxLevel && (
          <div className="w-32 sm:w-36 md:w-40 h-2 bg-gray-700 rounded-full overflow-hidden">
            <div
